...
export default function ResetPassword() { 
  ...
  const mySchema = Yup.object({ 
    ...
    newPassword: Yup.string().required('Password is required').matches(/^[A-Z][a-z0-9]{5,15}$/, 'Password must start with a capital letter and be at least 6 characters long'), 
  }); 
